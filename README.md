...
![my-page](assets/documentation/my-page.png)
...
![colour-palette](assets/documentation/colour-palette-image.png)
...
![heading](assets/documentation/heading.png)
...
* Code validation
* Lighthouse auditing
![performance](assets/documentation/performance.png)
...
![html-validation-result](assets/documentation/html-validation-result-image.png)

![gallery-validation-result](assets/documentation/gallery-validation-result-image.png)

![contact-validation-result](assets/documentation/contact-validation-result-image.png)

![css-validation-result](assets/documentation/css-validation-result-image.png)
...
* The image in home page benefits section was taken from [IUTF Facebook page](https://www.facebook.com/IrishUnitedTaekwondoFederation/photos/a.790238944399320/1229467877143089)
* The image in the home page timetable section was taken [tuffmommablog.net](http://tuffmommablog.net/wp-content/uploads/2020/07/img_8083-1024x660.png)
* The image in the contact page was taken [destinymartialarts.com](https://destinymartialarts.com/wp-content/uploads/2018/06/Free-Summer-TaeKwon-Do-Website-stock.png)
